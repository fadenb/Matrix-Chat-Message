...
async function requestKeysDuringVerification(baseApis, userId, deviceId) {
  ...
  console.log("Cross-signing: Self-verification done; requesting keys"); // This happens asynchronously, and we're not concerned about waiting for
  ...
  return new Promise((resolve, reject) => {
    ...
    const crossSigning = new CrossSigningInfo(original.userId, {
      getCrossSigningKey: async type => {
        console.debug("Cross-signing: requesting secret", type, deviceId);
        const {
          promise
